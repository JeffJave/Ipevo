                    ...
                    try
                    {
                        PXLongOperation.StartOperation(Base, () =>
                        {
                            ...
                            using (PXLoginScope pXLoginScope = new PXLoginScope($"{curUserName}@{curLMICVendor.LoginName}"))
                            {
                                ...
                                //sOOrder.CuryID = PXSelect<Customer, Where<Customer.bAccountID, Equal<Required<Customer.bAccountID>>>>.Select(sOOrderEntry, curLMICCustomer.CustomerID)?.TopFirst.CuryID;
