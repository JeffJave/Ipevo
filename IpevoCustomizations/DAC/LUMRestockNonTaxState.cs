...
namespace IpevoCustomizations.DAC
{
    ...
    [PXPrimaryGraph(typeof(LUMRestockNonTaxStateMaint))]
    public class LUMRestockNonTaxState : IBqlTable
    {
        #region Keys
        public class PK : PrimaryKeyOf<LUMRestockNonTaxState>.By<stateID>
        {
            public static LUMRestockNonTaxState Find(PXGraph graph, string stateID) => FindBy(graph, stateID);
        }
        #endregion
